...
int main(void)
{
    printf("Press 0 if stock info is to read from a file and 1 if stock info is to be entered manually: ");
    int STOCK_FROM_STDIN;
    scanf("%d", &STOCK_FROM_STDIN);
    ...
    printf("\n");
    centreText(70, '*', " Groceries - Opening Stock ");
    printf("\n");
    centreText(70, '=', "");
    printf("\n");
